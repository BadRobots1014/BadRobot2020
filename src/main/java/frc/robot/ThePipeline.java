...
public class ThePipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {0.0, 40.238907849829346};
		double[] hsvThresholdSaturation = {158.7682396455717, 255.0};
		double[] hsvThresholdValue = {87.24825224566109, 184.30887372013652};
		hsvThreshold(hsvThresholdInput, hsvThresholdHue, hsvThresholdSaturation, hsvThresholdValue, hsvThresholdOutput);

		// Step CV_medianBlur0:
		Mat cvMedianblurSrc = hsvThresholdOutput;
		double cvMedianblurKsize = 3.0;
		cvMedianblur(cvMedianblurSrc, cvMedianblurKsize, cvMedianblurOutput);

		// Step CV_erode0:
		Mat cvErodeSrc = cvMedianblurOutput;
